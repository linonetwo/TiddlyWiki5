				...
				if(variableInfo.text) {
					if(srcVariable.isFunctionDefinition) {
						...
						if(variableInfo.isCacheable && srcVariable[cacheKey]) {
							...
							parser = this.wiki.parseText(this.transcludeType, variableInfo.text || "", {
								parseAsInline: parseAsInline,
								configTrimWhiteSpace: srcVariable.configTrimWhiteSpace,
							});
...
Compose a string comprising the title, field and/or index to identify this transclusion for recursion detection
	*/
	...
	TranscludeWidget.prototype.parserNeedsRefresh = function() {
		...
		return (this.sourceText === undefined || parserInfo.sourceText !== this.sourceText ||
