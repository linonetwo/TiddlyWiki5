	...
	*/
	exports.getFullScreenApis = function() {
		var d = document,
			db = d.body,
			result = {
				_requestFullscreen: db.webkitRequestFullscreen !== undefined
					...
					? "requestFullscreen"
					: "",
				_exitFullscreen: d.webkitExitFullscreen !== undefined
					...
					? "exitFullscreen"
					: "",
				_fullscreenElement: d.webkitFullscreenElement !== undefined
