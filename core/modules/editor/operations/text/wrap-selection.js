...
(function() {
	...
	exports["wrap-selection"] = function(event, operation) {
		if(operation.selStart === operation.selEnd) {
			...
			operation.text.substring(operation.selStart, operation.selStart + event.paramObject.prefix.length) ===
				event.paramObject.prefix &&
			operation.text.substring(operation.selEnd - event.paramObject.suffix.length, operation.selEnd) ===
