	...
	KeyboardManager.prototype.updateShortcutLists = function(tiddlerList) {
		...
		for(var i = 0; i < tiddlerList.length; i++) {
			...
			this.shortcutParsedList[i] = this.shortcutKeysList[i] !== undefined
				? this.parseKeyDescriptors(this.shortcutKeysList[i])
				: undefined;
...
options:
	...
	*/
	...
	KeyboardManager.prototype.handleShortcutChanges = function(changedTiddlers) {
		...
		var hasChanged = $tw.utils.hopArray(changedTiddlers, this.shortcutTiddlers)
			? true
			: ($tw.utils.hopArray(changedTiddlers, newList)
				? true
