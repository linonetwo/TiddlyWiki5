...
(function() {
	...
	describe("HTML tag new parser tests", function() {
			...
			expect($tw.utils.parseMacroInvocation("<<mymacro one two three>>", 0)).toEqual(
				{
					type: "macrocall",
					start: 0,
					params: [{type: "macro-parameter", start: 9, value: "one", end: 13}, {
						type: "macro-parameter",
						start: 13,
						value: "two",
						end: 17,
					}, {type: "macro-parameter", start: 17, value: "three", end: 23}],
					name: "mymacro",
					end: 25,
				},
			);
			expect($tw.utils.parseMacroInvocation("<<mymacro p:one q:two three>>", 0)).toEqual(
				{
					type: "macrocall",
					start: 0,
					params: [{type: "macro-parameter", start: 9, value: "one", name: "p", end: 15}, {
						type: "macro-parameter",
						start: 15,
						value: "two",
						name: "q",
						end: 21,
					}, {type: "macro-parameter", start: 21, value: "three", end: 27}],
					name: "mymacro",
					end: 29,
				},
			);
			expect($tw.utils.parseMacroInvocation("<<mymacro 'one two three'>>", 0)).toEqual(
				{
					type: "macrocall",
					start: 0,
					params: [{type: "macro-parameter", start: 9, value: "one two three", end: 25}],
					name: "mymacro",
					end: 27,
				},
			);
			expect($tw.utils.parseMacroInvocation("<<mymacro r:'one two three'>>", 0)).toEqual(
				{
					type: "macrocall",
					start: 0,
					params: [{type: "macro-parameter", start: 9, value: "one two three", name: "r", end: 27}],
					name: "mymacro",
					end: 29,
				},
			);
			expect($tw.utils.parseMacroInvocation("<<myMacro one:two three:'four and five'>>", 0)).toEqual(
				{
					type: "macrocall",
					start: 0,
					params: [{type: "macro-parameter", start: 9, value: "two", name: "one", end: 17}, {
						type: "macro-parameter",
						start: 17,
						value: "four and five",
						name: "three",
		...
		it("should parse HTML tags", function() {
			...
			expect(parser.parseTag("<mytag attrib1>", 0)).toEqual(
				{
					type: "element",
					start: 0,
					attributes: {attrib1: {type: "string", value: "true", start: 6, name: "attrib1", end: 14}},
					orderedAttributes: [{start: 6, name: "attrib1", type: "string", value: "true", end: 14}],
					tag: "mytag",
					end: 15,
				},
			);
			...
			expect(parser.parseTag('<$view field="title" format="link"/>', 0)).toEqual(
				{
					...
					start: 0,
					attributes: {
						field: {start: 6, name: "field", type: "string", value: "title", end: 20},
						format: {start: 20, name: "format", type: "string", value: "link", end: 34},
					},
					orderedAttributes: [{start: 6, name: "field", type: "string", value: "title", end: 20}, {
						start: 20,
						name: "format",
						type: "string",
						value: "link",
			...
			expect(parser.parseTag("<mytag attrib1='something'>", 0)).toEqual(
				{
					type: "element",
					start: 0,
					attributes: {attrib1: {type: "string", start: 6, name: "attrib1", value: "something", end: 26}},
					orderedAttributes: [{start: 6, name: "attrib1", type: "string", value: "something", end: 26}],
					tag: "mytag",
					end: 27,
				},
			);
			expect(parser.parseTag("<mytag attrib1 attrib1='something'>", 0)).toEqual(
				{
					type: "element",
					start: 0,
					attributes: {attrib1: {type: "string", start: 15, name: "attrib1", value: "something", end: 34}},
					orderedAttributes: [{start: 6, name: "attrib1", type: "string", value: "true", end: 15}, {
						start: 15,
						name: "attrib1",
						type: "string",
						value: "something",
			...
			expect(parser.parseTag("<mytag attrib1 attrib1='something' attrib1='else'>", 0)).toEqual(
				{
					type: "element",
					start: 0,
					attributes: {attrib1: {type: "string", start: 34, name: "attrib1", value: "else", end: 49}},
					orderedAttributes: [{start: 6, name: "attrib1", type: "string", value: "true", end: 15}, {
						start: 15,
						name: "attrib1",
						type: "string",
					...
					}, {start: 34, name: "attrib1", type: "string", value: "else", end: 49}],
					tag: "mytag",
					end: 50,
				},
			);
			expect(parser.parseTag("<$mytag attrib1='something' attrib2=else thing>", 0)).toEqual(
				{
					...
					start: 0,
					attributes: {
						attrib1: {type: "string", start: 7, name: "attrib1", value: "something", end: 27},
						attrib2: {type: "string", start: 27, name: "attrib2", value: "else", end: 40},
						thing: {type: "string", start: 40, name: "thing", value: "true", end: 46},
					},
					orderedAttributes: [{start: 7, name: "attrib1", type: "string", value: "something", end: 27}, {
						start: 27,
						name: "attrib2",
						type: "string",
						value: "else",
						end: 40,
					}, {start: 40, name: "thing", type: "string", value: "true", end: 46}],
					tag: "$mytag",
					end: 47,
				},
			);
					...
					attributes: {
						attrib3: {
							...
							value: {
								type: "macrocall",
								start: 16,
								params: [{type: "macro-parameter", start: 25, value: "two", name: "one", end: 33}, {
									type: "macro-parameter",
									start: 33,
									value: "four and five",
									name: "three",
			...
			expect(
				parser.parseTag(
					"<$mytag attrib1='something' attrib2=else thing attrib3=<<myMacro one:two three:'four and five'>>>",
					0,
				),
			).toEqual(
				{
					...
					attributes: {
						attrib1: {type: "string", start: 7, name: "attrib1", value: "something", end: 27},
						attrib2: {type: "string", start: 27, name: "attrib2", value: "else", end: 40},
						thing: {type: "string", start: 40, name: "thing", value: "true", end: 47},
						attrib3: {
							type: "macro",
							start: 47,
							name: "attrib3",
							value: {
								type: "macrocall",
								start: 55,
								params: [{type: "macro-parameter", start: 64, value: "two", name: "one", end: 72}, {
									type: "macro-parameter",
									start: 72,
									value: "four and five",
									name: "three",
					...
					orderedAttributes: [
						{type: "string", start: 7, name: "attrib1", value: "something", end: 27},
						{type: "string", start: 27, name: "attrib2", value: "else", end: 40},
						{type: "string", start: 40, name: "thing", value: "true", end: 47},
						{
							type: "macro",
							start: 47,
							name: "attrib3",
			...
			expect(parser.findNextTag("<<some other stuff>> <mytag>", 0)).toEqual(
				{
					...
					start: 1,
					attributes: {
						other: {type: "string", value: "true", start: 6, name: "other", end: 13},
						stuff: {type: "string", value: "true", start: 13, name: "stuff", end: 18},
					},
					orderedAttributes: [{type: "string", value: "true", start: 6, name: "other", end: 13}, {
						type: "string",
						value: "true",
						start: 13,
						name: "stuff",
