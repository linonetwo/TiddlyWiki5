...
(function() {
	...
	exports.startup = function() {
		...
		$tw.hooks.addHook("th-importing-file", function(info) {
			if(
				document.location.protocol === "file:" && info.isBinary && info.file.path &&
...
rootpath comes from document.location.pathname with urlencode applied with the following patterns:
	...
	*/
	function makePathRelative(sourcepath, rootpath, options) {
		...
		if(
			c === 1 || (options.useAbsoluteForNonDescendents && c < rootParts.length) ||
	...
	function test_makePathRelative() {
		var test = function(sourcepath, rootpath, result, options) {
			...
			if(actualResult !== result) {
				console.log(
					"makePathRelative test failed: makePathRelative(" + sourcepath + "," + rootpath + "," + JSON.stringify(options) +
						") is " + actualResult + " and not equal to " + result,
				);
			}
		};
		test("/Users/me/something/file.png", "/Users/you/something/index.html", "../../me/something/file.png");
		test("/Users/me/something/file.png", "/Users/you/something/index.html", "/Users/me/something/file.png", {
			useAbsoluteForNonDescendents: true,
		});
		...
		test("/Users/me/something/file.png", "/Users/me/something/new/index.html", "/Users/me/something/file.png", {
			useAbsoluteForNonDescendents: true,
		});
		test("/Users/me/something/file.png", "/Users/me/something/index.html", "file.png");
		test(
			"/Users/jeremyruston/Downloads/Screenshot 2020-10-18 at 15.33.40.png",
			"/Users/jeremyruston/git/Jermolene/TiddlyWiki5/editions/prerelease/output/index.html",
			"../../../../../../Downloads/Screenshot%202020-10-18%20at%2015.33.40.png",
		);
		test(
			"/Users/me/nothing/image.png",
			"/Users/me/something/a/b/c/d/e/index.html",
			"../../../../../../nothing/image.png",
		);
		test("C:\\Users\\me\\something\\file.png", "/C:/Users/me/something/index.html", "file.png", {isWindows: true});
		test(
			"\\\\SHARE\\Users\\me\\something\\file.png",
			"/SHARE/Users/me/somethingelse/index.html",
			"../something/file.png",
			{isWindows: true},
		);
		test(
			"\\\\SHARE\\Users\\me\\something\\file.png",
			"/C:/Users/me/something/index.html",
			"/SHARE/Users/me/something/file.png",
			{isWindows: true},
		);
	}
