...
Information about this macro
	*/
	...
	var QRCODE_GENERATION_ERROR_PREFIX =
			'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300"><text x="0" y="30" fill="red" font-family="Helvetica, sans-serif" font-size="18">',
	...
	*/
	exports.run = function(text, size, errorCorrectLevel, fallback) {
		...
		try {
			...
			result = fallback ||
				("data:image/svg+xml," + encodeURI(QRCODE_GENERATION_ERROR_PREFIX + ex + QRCODE_GENERATION_ERROR_SUFFIX));
		}
		return result || "";
	};
